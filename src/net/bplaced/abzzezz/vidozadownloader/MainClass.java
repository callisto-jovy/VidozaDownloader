package net.bplaced.abzzezz.vidozadownloader;

import net.bplaced.abzzezz.vidozadownloader.util.ConsoleUtil;
import net.bplaced.abzzezz.vidozadownloader.util.Decoder;
import net.bplaced.abzzezz.vidozadownloader.util.RBCWrapper;
import net.bplaced.abzzezz.vidozadownloader.util.URLUtil;
import net.bplaced.abzzezz.vidozadownloader.util.cache.CacheUtil;
...
public class MainClass {
    ...
    private final CacheUtil cacheUtil = new CacheUtil(new File(System.getProperty("user.home"), "Vidoza-Downloader"));
    ...
    private void start(final String[] args) {
        ...
        System.out.println("Enter vidoza.net url:");
        ...
        try {
            final String decodedUrl = decoder.decodeVidoza(passedArguments ? args[0] : inputURL);
